        ...
        {activeSection === "profile" ? (
          <section className={panelClass}>
            ...
            <div className="mt-3 grid gap-3 md:grid-cols-2">
              ...
              <label className="text-sm">Google Scholar URL<input value={draft.profile.googleScholar ?? ""} onChange={(event) => setDraft((c) => ({ ...c, profile: { ...c.profile, googleScholar: event.target.value || undefined } }))} className={inputClass} /></label>
              <label className="text-sm">ResearchGate URL<input value={draft.profile.researchGate ?? ""} onChange={(event) => setDraft((c) => ({ ...c, profile: { ...c.profile, researchGate: event.target.value || undefined } }))} className={inputClass} /></label>
